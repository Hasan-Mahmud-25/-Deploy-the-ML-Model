...
# Load CSVs
# -----------------------------
clv_dashboard = pd.read_csv("artifacts/reports/clv_dashboard_full.csv")
top_vips = pd.read_csv("artifacts/reports/top_vips.csv")
growth_targets = pd.read_csv("artifacts/reports/growth_targets.csv")
segments = pd.read_csv("artifacts/reports/clv_segments_sample.csv")
all_features = pd.read_csv("artifacts/reports/all_models_top25_business_terms.csv")
...
col1.metric("Total Predicted CLV", f"${total_pred_clv:,.0f}")
col2.metric("Total Target CLV", f"${total_target:,.0f}")
col3.metric("CLV vs Target", f"${total_pred_clv - total_target:,.0f}")
